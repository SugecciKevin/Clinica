...
<div class="form-floating mb-3">
    <input type="number" id="id" name="id" class="form-control" readonly placeholder="" value="{{$Paciente->id}}"
    @if (isset($pacienteee))
        value={{$paciente->id}}
    @endif
    required />
...
<div class="form-floating mb-3">
    <input type="text" id="nombre" name="nombre" class="form-control" readonly placeholder="" value="{{$Paciente->nombre}}"
    @if (isset($pacienteee))
...
<div class="form-floating mb-3">
    <input type="date" id="fecha" name="fecha" class="form-control" redonly placeholder="" value="{{$Paciente->fecha_nacimiento}}"
    @if (isset($pacienteee))
